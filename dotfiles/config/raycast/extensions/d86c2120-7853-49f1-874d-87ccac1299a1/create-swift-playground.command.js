"use strict";var G=Object.create;var w=Object.defineProperty;var J=Object.getOwnPropertyDescriptor;var Q=Object.getOwnPropertyNames;var Y=Object.getPrototypeOf,Z=Object.prototype.hasOwnProperty;var b=(o,e)=>()=>(e||o((e={exports:{}}).exports,e),e.exports),_=(o,e)=>{for(var n in e)w(o,n,{get:e[n],enumerable:!0})},k=(o,e,n,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Q(e))!Z.call(o,i)&&i!==n&&w(o,i,{get:()=>e[i],enumerable:!(t=J(e,i))||t.enumerable});return o};var u=(o,e,n)=>(n=o!=null?G(Y(o)):{},k(e||!o||!o.__esModule?w(n,"default",{value:o,enumerable:!0}):n,o)),ee=o=>k(w({},"__esModule",{value:!0}),o);var D=b((ce,x)=>{"use strict";function te(o){var e=void 0;typeof o=="string"?e=[o]:e=o.raw;for(var n="",t=0;t<e.length;t++)n+=e[t].replace(/\\\n[ \t]*/g,"").replace(/\\`/g,"`"),t<(arguments.length<=1?0:arguments.length-1)&&(n+=arguments.length<=t+1?void 0:arguments[t+1]);var i=n.split(`
...
`)),n=n.trim(),n.replace(/\\n/g,`
`)}typeof x<"u"&&(x.exports=te)});var O=b((ye,L)=>{"use strict";var re=require("os"),I=re.homedir();L.exports=o=>{if(typeof o!="string")throw new TypeError(`Expected a string, got ${typeof o}`);return I?o.replace(/^~(?=$|\/|\\)/,I):o}});var ie={};_(ie,{default:()=>ne});module.exports=ee(ie);var a=require("@raycast/api");var S=(t=>(t.iOS="ios",t.macOS="macos",t.tvOS="tvos",t))(S||{});var V=require("child_process"),A=require("util"),h=(0,A.promisify)(V.exec);var j=u(D());var g=(t=>(t.Empty="Empty",t.SwiftUI="SwiftUI",t.UIKit="UIKit",t))(g||{});var c=u(require("fs")),v=o=>c.default.promises.access(o,c.default.constants.F_OK).then(()=>!0).catch(()=>!1),me=c.default.promises.readdir,F=c.default.promises.mkdir,E=c.default.promises.rm,de=c.default.promises.readFile,U=c.default.promises.writeFile,fe=c.default.promises.rm;var R=u(O()),P=u(require("path"));var $=require("@raycast/api"),oe=(0,$.getPreferenceValues)();var X=oe;var f=class o{static{this.scaffoldTemplateFiles=[{path:"playground.xcworkspace",name:"contents",extension:"xcworkspacedata",contents:`
