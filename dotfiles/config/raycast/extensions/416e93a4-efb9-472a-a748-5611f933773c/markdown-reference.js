"use strict";var p=Object.defineProperty;var g=Object.getOwnPropertyDescriptor;var f=Object.getOwnPropertyNames;var b=Object.prototype.hasOwnProperty;var x=(t,n)=>{for(var i in n)p(t,i,{get:n[i],enumerable:!0})},y=(t,n,i,a)=>{if(n&&typeof n=="object"||typeof n=="function")for(let e of f(n))!b.call(t,e)&&e!==i&&p(t,e,{get:()=>n[e],enumerable:!(a=g(n,e))||a.enumerable});return t};var T=t=>y(p({},"__esModule",{value:!0}),t);var H={};x(H,{default:()=>M});module.exports=T(H);var o=require("@raycast/api"),k=require("react");var v=[{name:"Blockquotes",description:"To create a blockquote, add a `>` in front of a paragraph.",examples:[{markdown:"> Dorothy followed her through many of the beautiful rooms in her castle.",html:"<blockquote><p>Dorothy followed her through many of the beautiful rooms in her castle.</p></blockquote>"}],additional_examples:[{name:"Blockquotes with Multiple Paragraphs",description:"Blockquotes can contain multiple paragraphs. Add a `>` on the blank lines between the paragraphs.",markdown:`> Dorothy followed her through many of the beautiful rooms in her castle.
...
`,i+=`
${d(a.markdown)}
`})),(0,m.jsx)(r.Detail,{markdown:i,actions:(0,m.jsx)(r.ActionPanel,{children:(0,m.jsx)(r.ActionPanel.Item,{title:"Back",onAction:n})})})},u=F;var s=require("react/jsx-runtime"),I=()=>{let[t,n]=(0,k.useState)(l),{push:i}=(0,o.useNavigation)(),a=e=>{if(e!==""){let h=l.filter(w=>{let c=w.name.toLowerCase().split(" ");return c[0].startsWith(e)||c.length>1&&c[1].startsWith(e)});n(h)}else n(l)};return(0,s.jsx)(o.List,{onSearchTextChange:e=>a(e.toLowerCase()),children:t.length>0&&t.map((e,h)=>(0,s.jsx)(o.List.Item,{title:e.name,actions:(0,s.jsx)(o.ActionPanel,{children:(0,s.jsx)(o.ActionPanel.Item,{title:"View",onAction:()=>i((0,s.jsx)(u,{name:e.name,description:e.description,examples:e.examples,additional_examples:e.additional_examples}))})})},h))})},M=I;
